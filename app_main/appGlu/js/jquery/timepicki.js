		...
		return this.each(function() {
			...
			var new_ele = $(
				"<div class='timepicker_wrap " + settings.custom_classes + "'>" +
					...
					"<div class='time'>" +
						top_arrow_button +
						"<div class='ti_tx'><input type='number' id='ti_tx_input' class='timepicki-input'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "></div>" +
						bottom_arrow_button +
					"</div>" +
					"<div class='mins'>" +
						top_arrow_button +
						"<div class='mi_tx'><input type='number' id='mi_tx_input' class='timepicki-input'" + (settings.disable_keyboard_mobile ? "readonly" : "") + "></div>" +
						bottom_arrow_button +
					"</div>");
			if(settings.show_meridian){
				new_ele.append(
					"<div class='meridian'>" +
						top_arrow_button +
						"<div class='mer_tx'><input type='text' id='mer_tx_input' class='timepicki-input' readonly='readonly'></div>" +
						bottom_arrow_button +
					"</div>");
			}
			if(settings.reset){
			...
			$(document).on('click','input[type="time"]',function(){
				...
				if($(this).attr('id') == 'sleep_SLEEP_END_TM' || $(this).attr('id') == 'sleepEndTm'){
					var mTi = '07';
					var mMi = '00';
					var mMer = "AM";
					ele.attr('data-timepicki-tim',mTi)
					ele.attr('data-timepicki-mini',mMi)
					ele.attr('data-timepicki-meri',mMer)
				}
				open_timepicki();
			});
