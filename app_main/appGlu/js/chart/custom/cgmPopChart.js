...
//	;
	...
	xLabel.selectAll(".label_text")
	    ...
	    .text(function(d, i){
	    	var rtnStr = "";
	    	var hh = Number(param.tm.substring(0,2));
	    	var mm = param.tm.substring(2,4);
	    	
	    	if(d%30==0&&d!=0&&d!=60&&d!=180){
	    		hh = hh - 1 < 10 ? "0" + (hh - 1) : hh - 1;
	    		rtnStr = setAddTm(hh+":"+mm,d);
